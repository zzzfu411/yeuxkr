...
assert(vocabularyPage.includes("gateConcealment(\"vocab\"") && hangulPage.includes("gateConcealment(\"hangul\"") && hangulPage.includes("gateConcealment(\"pronunciation\""), "vocab, hangul, and pronunciation cards should conceal source chrome while a mastery gate is open");
