...
assert(learningCompassSource.includes("nav-scroll flex w-full max-w-full snap-x gap-2 overflow-x-auto"), "LearningCompass condensed route strip should be horizontally scrollable on mobile");
...
assert(homePage.includes("<MobileHeroMetric"), "home page should use a compact mobile metric strip instead of a full dashboard card in the hero");
...
assert(playerSource.includes("splitTrackHref") && playerSource.includes("nowPlayingNav") && playerSource.includes("getNowPlayingLocationSearch") && playerSource.includes("window.location.search") && nowPlayingSource.includes("subscribeNowPlayingLocation"), "now playing should match query tracks and not treat unmatched pages as index 0");
