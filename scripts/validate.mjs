...
assert(immersionPage.includes("landingReady") && immersionPage.includes("if (!requestedMaterialId) return") && immersionPage.includes("resolveImmersionActiveMaterialId"), "immersion should pin the landing material and ignore empty query fallback to a drifting default");
