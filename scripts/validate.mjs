...
assert(hangulPage.includes("siblingLocked") && hangulPage.includes("hangulGateOpen") && hangulPage.includes("soundChangeGateOpen") && vocabularyPage.includes("siblingLocked") && grammarPage.includes("siblingLocked"), "unpaginated and current-page library siblings should conceal answer-space chrome while any same-section gate is open");
...
assert(smokeBrowser.includes("assertMasteryGateChromeDoesNotSpoil") && smokeBrowser.includes("assertLibrarySiblingChromeDoesNotSpoil") && smokeBrowser.includes("vocab gate") && smokeBrowser.includes("hangul gate") && smokeBrowser.includes("pronunciation gate") && smokeBrowser.includes("sound-change gate"), "browser smoke should lock MasteryGate chrome and sibling TrackRows against open-book spoilers");
