  ...
  return (
    <div className="grid gap-3 rounded-[8px] border border-[rgba(79,140,118,0.45)] bg-[rgba(79,140,118,0.1)] p-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
      <div>
        ...
        <p className="mt-1 text-sm font-bold leading-6 text-[var(--muted)]">
          {unlocked
            ? `${assessment.listeningDeferred ? "本课内容已通过；设备音频不可用，听力证据仍待补。" : "总分、主动输出与听辨分项均已核验。"} 你可以继续下一课，或把 ${bridge.reviewCards} 张复习卡送回长期记忆。`
            : "这次只记录预览分数；核心路径仍建议先补齐前置课。"}
        </p>
      </div>
      <div className="flex flex-wrap gap-2">
...
function lessonAssessmentMessage(assessment: LessonAssessmentResult) {
  ...
  if (assessment.listeningRequired && !assessment.listeningPassed && !assessment.listeningDeferred) missing.push("听辨题需达到 60%");
...
function LessonTaskEvidencePanel({
  ...
  return (
    <Surface id="lesson-task-evidence" className="scroll-mt-40 lg:scroll-mt-28">
      ...
      {task.source ? (
        <div className="mt-4 rounded-[8px] border border-[var(--line)] bg-[rgba(23,63,115,0.05)] p-4">
      ...
      {task.kind === "shadowing" ? (
        <div className="mt-4 grid gap-3 rounded-[8px] border border-[var(--line)] p-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
          <div>
      ...
      <label className="mt-4 grid gap-2 text-sm font-black">
        ...
        <textarea
          className="focus-ring hangul-display min-h-40 w-full resize-y rounded-[8px] border border-[var(--line-strong)] bg-[var(--surface-solid)] p-4 text-lg font-bold leading-8"
          value={text}
          lang="ko"
          spellCheck={false}
      ...
      <div className="mt-4 grid gap-2 rounded-[8px] border border-[var(--line)] bg-[rgba(79,140,118,0.06)] p-4">
...
function CapstoneEvidencePanel({
  ...
  return (
    <Surface className="border-[rgba(23,63,115,0.28)]" >
      <div id="capstone-evidence" className="scroll-mt-40 lg:scroll-mt-28">
        ...
        />
        <div className="mb-4 grid gap-3 rounded-[8px] border border-[var(--line-strong)] bg-[rgba(185,78,60,0.05)] p-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.8fr)]">
          <label className="grid gap-2 text-sm font-extrabold">
            两分钟结构化输出稿
            <textarea
              className="focus-ring min-h-72 rounded-[8px] border border-[var(--line-strong)] bg-[var(--surface-solid)] p-3 leading-7"
          ...
          <div className="grid content-start gap-3">
            <div className="grid gap-1.5 rounded-[8px] border border-[var(--line)] bg-[rgba(23,63,115,0.05)] p-3">
            ...
            <div className="grid gap-2">
              {capstoneRubric.map((item) => {
                ...
                return (
                  <label key={item.id} className={`focus-ring grid cursor-pointer grid-cols-[1.5rem_minmax(0,1fr)] items-center gap-2 rounded-[8px] border p-3 text-sm font-bold ${checked ? "border-[rgba(79,140,118,0.48)] bg-[rgba(79,140,118,0.1)]" : "border-[var(--line)] bg-[var(--surface-solid)]"}`}>
