...
export function RomanizationText({
  ...
  return (
    <span className="flex flex-wrap items-center gap-2">
      <button
        type="button"
        className="focus-ring inline-flex min-h-11 items-center gap-1.5 rounded-none border border-[var(--line)] bg-[var(--surface-solid)] px-2.5 text-xs font-black text-[var(--ocean)]"
